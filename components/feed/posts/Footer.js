...
export default function Footer() {
  ...
  return (
    <div className='mx-2 justify-between pb-2 flex text-gray-300 font-medium'>
      <div onMouseEnter={handlePopupReactEmoji} onMouseLeave={handleRemoveReactEmoji} className="flex cursor-pointer hover:bg-gray-hover px-[4.5rem] 3xl:px-[3rem] pt-1 pb-2 rounded-lg items-center m-auto text-center justify-center">
        {
      ...
      <div className="flex cursor-pointer hover:bg-gray-hover px-[4.5rem] 3xl:px-[3rem] pt-1 pb-2 rounded-lg items-center m-auto">
