...
return (
    <div className='bg-[#242526] h-auto w-full rounded-xl'>
      ...
      <input onClick={handleModal} type='text' readOnly className='bg-[#3a3b3c] text-white rounded-full h-10 w-11/12 px-5 ml-2 mr-2 outline-none focus:outline-none ' placeholder={`What's on your mind, ${name}?`} />
      </div>
